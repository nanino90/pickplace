...
QT_MOC_LITERAL(1, 8, 14), // "setDestination"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 1), // "x"
QT_MOC_LITERAL(4, 26, 1), // "y"
QT_MOC_LITERAL(5, 28, 9) // "collision"

    },
    "Manager\0setDestination\0\0x\0y\0collision"
};
...
void Manager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Manager::*_t)(qreal , qreal );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Manager::setDestination)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Manager::setDestination(qreal _t1, qreal _t2)
{
